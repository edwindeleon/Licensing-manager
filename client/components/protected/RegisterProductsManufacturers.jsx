...
export default class RegisterProductsManufacturers extends Component {
  ...
  handleSubmit(e) {
    ...
    const partnersRef = firebaseDatabase.ref(`productsManufacturers/`)
    ...
    this.setState(setSuccessMsg('Manufacturer created successful.'))
      this.setState({
      typeTitle: ''
    });
