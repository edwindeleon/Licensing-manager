...
export default class RegisterProductsTypes extends Component {
  ...
  handleSubmit(e) {
    ...
    const partnersRef = firebaseDatabase.ref(`productsTypes/`)
    ...
    this.setState(setSuccessMsg('Type created successful.'))
      this.setState({
      title: ''
    });
