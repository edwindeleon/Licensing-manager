...
export default class RegisterCompetitorProduct extends Component {
  ...
  handleSubmit(e) {
    ...
    const partnersRef = firebaseDatabase.ref(`competitorsProducts/`)
    ...
    this.setState(setSuccessMsg('Product created successful.'))
      this.setState({
      title: ''
    });
