...
export default class RegisterLicenseGrantTypes extends Component {
  ...
  handleSubmit(e) {
    ...
    const partnersRef = firebaseDatabase.ref(`licenseGrantTypes/`)
    ...
    this.setState(setSuccessMsg('Grant Type created successful.'))
      this.setState({
      title: ''
    });
